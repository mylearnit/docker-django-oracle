...
RUN apt-get update -qq && apt-get -y install alien wget git git-core libaio1
...
RUN pip install git+https://github.com/manelclos/django-oracle-backend.git#egg=django-oracle-backend
